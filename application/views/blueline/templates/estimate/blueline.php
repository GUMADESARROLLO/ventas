...
<div class="top-background">
   <table width="100%" cellspacing="0" >
         <tr>
           <td colspan='2' class="center" ><img src="<?php if( $core_settings->pdf_path == 1 ) {echo base_url(); } ?><?=$core_settings->invoice_logo;?>" class="company-logo" /></td>
        ...
        <tr>
          <td colspan='2' class="padding" align="right" style="vertical-align:bottom">
          <strong><?php echo date($core_settings->date_format, human_to_unix($estimate->issue_date.' 00:00:00'));?></strong>
          </td>
        </tr>
  </table>
...
<div class="content">
  ...
  <tr class="header"> 
    ...
    <th width="15%" class="right"><?=$this->lang->line('application_vence');?></th>
  </tr> 
  </thead> 
  <tbody> 
  <?php $i = 0; $sum = 0; $row=false; ?>
    ...
    <tr <?php if($row){?>class="even"<?php } ?>>
      <td>
        ...
        <span class="description"><?php echo $value->code;?> &bull; <?=$description;?> &bull; <?php echo $value->type;?>  <span class="item-name">
      </td>
      ...
      <td class="right"><?php echo $estimate->invoice_has_items[$i]->expira;?></td>
    </tr>
  ...
  ?>
        ...
        <tr>
          <?php if ($estimate->discount != 0): ?>
            <td class="side">
              <span class="over"><?=$this->lang->line('application_discount');?></span><br/>
              <span class="under">- <?=display_money($discount, $estimate->currency);?></span>
            </td>
            <?php endif ?>
          <td class="side">
            <span class="over">CANTIDAD EN LETRAS</span><br/>
            <span class="under"><?php echo number_words($sum,"cordobas","con","centavos");?></span>
          </td>
